...
class SystemAppTest(unittest.TestCase):
    ...
    def testLaunchAndExitMediaExplorer(self):
        ...
        assert d(resourceId='com.xiaomi.mitv.mediaexplorer:id/dev', text='设备').wait.exists(timeout=15000), 'launch Media Explorer failed!'
        assert d(resourceId='com.xiaomi.mitv.mediaexplorer:id/video', text="视频").wait.exists(timeout=15000), 'launch Media Explorer failed!'       
        d.press('back')
        d.sleep(3)
        d.press('back')
